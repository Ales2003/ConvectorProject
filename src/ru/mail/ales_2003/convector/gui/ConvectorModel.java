...
public class ConvectorModel extends AbstractTableModel
{
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            case 0:
                return convector.getConvectorId();
            case 1:
                return convector.getLength();
            case 2:
                return convector.getWidth();
            case 3:
                return convector.getDepth();
            case 4:
                return convector.getPrice();
            default:
                return convector.getPower();
        }
    }
}
